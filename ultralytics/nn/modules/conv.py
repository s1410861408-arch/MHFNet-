...
__all__ = ('Conv', 'Conv2', 'LightConv', 'DWConv', 'DWConvTranspose2d', 'ConvTranspose', 'Focus', 'GhostConv',
           'ChannelAttention', 'SpatialAttention', 'CBAM', 'Concat', 'RepConv','ACBlock','Silence','SilenceChannel','ChannelToNumber','NumberToChannel', "DConv")
...
class NumberToChannel(nn.Module):
    ...
    def forward(self, x):
        ...
        combined_output = torch.cat((x1, x2),
                                    dim=1)  # 将两个tensor按通道合并c_times_2, H, W)
        return combined_output
