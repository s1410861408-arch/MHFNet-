...
class TaskAlignedAssigner(nn.Module):
    ...
    def get_targets(self, gt_labels, gt_bboxes, target_gt_idx, fg_mask):
        ...
        # 修改增加了1-不确定度，原为target_scores.scatter_(2, target_labels.unsqueeze(-1), 1)，label.txt需要改为uncertainty
        target_scores.scatter_(2, target_labels.unsqueeze(-1), 1-target_labels.unsqueeze(-1))
